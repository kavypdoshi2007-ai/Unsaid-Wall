        ...
        fetch(API_ENDPOINTS.SESSIONS.GET_LISTING, {
            ...
            .then((data) => {
                ...
                if (sessions.length > 0) {
                    // Try to find an open session ('active' or 'approved') to dynamically connect to
                    const openSession = sessions.find(s => s.status === 'active' || s.status === 'approved') || sessions[0];
